...
|------------|-------------|
| **[Frontend](https://github.com/CV-Recognition/SOFRS-EA-Frontend)** | User interface for the face recognition access system |
| **[Backend](https://github.com/CV-Recognition/SOFRS-EA-Backend)** | API server, face recognition engine, and database integration |
...
> _"Bringing computer vision to life - one face at a time."_
